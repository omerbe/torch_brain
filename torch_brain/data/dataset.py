...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        # self._data_objects = {}
        # for recording_id, f in self._open_files.items():
        #     # if str(recording_id) not in bad_days:
        #     #     self._data_objects[str(recording_id)] = Data.from_hdf5(f, lazy=True)
        #     # if str(recording_id) in bad_days:
        #     print("file: ",f)
        #     for k, v in f.items():
        #         if isinstance(v, h5py.Group):
        #             print("file value: ",v)
        #             # print(v.attrs.keys())
        #             print("value.attrs:", list(v.attrs.items()))
